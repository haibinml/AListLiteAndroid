(function(){System.register([`./browser-BKLM0ThC-IxjwuOIz-legacy-JFTPqjwV.js`,`./pdf-legacy-slUg_9uV.js`],function(e,t){var n,r,i,a,o,s,c,l,u,d,f,p,m;function h(e,t){let{logger:i,encoderPoolSize:a,fontFallback:o}=t instanceof Object&&`debug`in t?{logger:t}:t||{},s=new Worker(URL.createObjectURL(new Blob([`var Rotation = /* @__PURE__ */ ((Rotation2) => {
